...
accuracy2 = history2.metrics_distributed['accuracy']
acc_values2 = [item[1] for item in accuracy2]
loss2 = history2.metrics_distributed['loss']
loss_values2 = [item[1] for item in loss2]

accuracy3 = history3.metrics_distributed['accuracy']
acc_values3 = [item[1] for item in accuracy3]
loss3 = history3.metrics_distributed['loss']
loss_values3 = [item[1] for item in loss3]

accuracy4 = history4.metrics_distributed['accuracy']
acc_values4 = [item[1] for item in accuracy4]
loss4 = history4.metrics_distributed['loss']
